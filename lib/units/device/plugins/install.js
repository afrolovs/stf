    ...
    router.on(wire.InstallMessage, function(channel, message) {
      ...
      pushApp()
        ...
        .catch(Promise.TimeoutError, function(err) {
          ...
          push.send([
            channel
          , reply.fail('Нестабильное соединение с девайсом – устройство не ответило за 5 минут')
          ])
        })
        ...
        .catch(function(err) {
          ...
          push.send([
            channel
          , reply.fail('Попробуй удалить наше приложение вручную и попробовать ещё раз.')
          ])
        })
    })
